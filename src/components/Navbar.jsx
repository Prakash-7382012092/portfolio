...
const Navbar = () => {
  ...
  return (
    <div className='bg-green-500 h-[100px] text-white h-[100px] max-w-[100%] mx-auto flex justify-between items-center sticky top-0 z-[200000]'>
        ...
        <div className={nav ? 'fixed h-full left-0 top-0 w-[80%] bg-[#202121] ease-in-out duration-500 z-[300000]':'fixed left-[-80%] '}>
            ...
            <ul className='p-8 text-2xl'>
                ...
                <li className='p-2'><a href='#work'>Gallery</a></li>
