...
const Navbar = () => {
  ...
  return (
    <div className='bg-green-500 h-[100px] text-white h-[100px] max-w-[100%] mx-auto flex justify-between items-center sticky top-0'>
        ...
        <div className={nav ? 'fixed h-full left-0 top-0 w-[80%] bg-[#202121] ease-in-out duration-500 z-[100000]':'fixed left-[-80%]'}>
